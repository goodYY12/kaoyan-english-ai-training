...
import { readingEnhancements2015 } from "../data/englishII/readingEnhancements2015.js";
...
import { applyEnglishIIReadingCorrections2015 } from "../data/englishII/readingCorrections2015.js";
import {
  englishIIClozeItems,
...
export function getEnglishIIReadings() {
  return readingData.map((reading) => {
    const correctedReading = applyEnglishIIReadingCorrections2015(applyEnglishIIReadingCorrections2014(applyEnglishIIReadingCorrections2013(applyEnglishIIReadingCorrections(reading))));
    const enhancement = readingEnhancements2010[correctedReading.id]
      ...
      ?? readingEnhancements2015[correctedReading.id]
      ?? {};
