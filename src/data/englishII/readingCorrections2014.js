...
const text4Passage = `When the government talks about infrastructure contributing to the economy, the focus is usually on roads, railways, broadband and energy. Housing is seldom mentioned.
...
But it is not just down to the government. While these measures would be welcome in the short term, we must face up to the fact that the existing 4.5-billion-pound programme of grants to fund new affordable housing, set to expire in 2015, is unlikely to be extended beyond then. The Labour party has recently announced that it will retain a large part of the coalition's spending plans if it returns to power. The housing sector needs to accept that we are very unlikely to ever return to the era of large-scale public grants. We need to adjust to this changing climate.
...
export function applyEnglishIIReadingCorrections2014(reading) {
  ...
  if (reading?.id === "2014-english2-text4") {
    return { ...reading, title: "Why Affordable Housing Needs Support", passage: text4Passage };
  }
