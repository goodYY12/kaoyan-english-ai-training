...
export const readingEnhancements2014 = {
  ...
  "2014-english2-text4": {
    articleStructure: "P1 says housing is overlooked in infrastructure policy; P2 explains political and communication barriers; P3-P5 describe the affordable-housing shortage and borrowing proposal; P6-P8 call for stable rental conditions and realistic funding expectations.",
    structureMap: [
      { paragraph: "P1", role: "Introduction", summary: "Housing receives too little attention when infrastructure's economic contribution is discussed." },
      { paragraph: "P2", role: "Cause", summary: "Housing is politically charged and poorly communicates its economic value." },
      { paragraph: "P3-P5", role: "Problem and policy", summary: "Affordable housing is in urgent shortage; more local borrowing flexibility could increase supply." },
      { paragraph: "P6-P8", role: "Recommendation", summary: "Stable rental funding and adaptation to less public grant support are necessary." },
    ],
    questions: {
      "2014-english2-text4-q36": analysis("Perhaps the most significant reason is that the issue has always been so politically charged.", "The most significant reason is political sensitivity.", "最重要的原因可能是住房问题一直带有很强的政治色彩。", "细节题：同义替换", "把 shoulder the blame 理解为住房部门责任过重，或把未能传达价值误解为失去价值。", "B 的 political factors 对应 politically charged。", "题干问 overall belief 时，重点抓作者用最高级标出的 most significant reason。"),
      "2014-english2-text4-q37": analysis("The comprehensive spending review offers an opportunity ... It needs to put historical prejudices to one side and take some steps to address our urgent housing need.", "The government should set aside historical prejudices.", "政府应抛开历史偏见，采取措施解决迫切的住房需求。", "推理题：问题原因", "把住房供给增加或政府失望当作已发生事实，忽略作者要求放下 historical prejudices。", "C 表示经济适用房受到政府偏见影响。", "推理题中政策建议反映的通常是现实存在的阻碍。"),
      "2014-english2-text4-q38": analysis("George Osborne ... may introduce more flexibility to the current cap on the amount that local authorities can borrow against their housing stock debt.", "Local authorities may be allowed to borrow more against housing debt.", "政府可能放宽地方政府以住房存量债务为抵押的借款额度。", "细节题：同义替换", "把放宽借款上限理解为停止建房、减少债务或直接发布 GDP 预测。", "A 概括了允许政府为住房承担更多债务。", "政策题先锁定 cap、borrow、lift 等动作词，再判断对象和方向。"),
      "2014-english2-text4-q39": analysis("Greater certainty in the rental environment ... would have a significant impact on the ability of registered providers to fund new developments from revenues.", "A stable rental environment helps providers fund new developments.", "更稳定的租赁环境会显著提升注册机构用收入为新开发项目融资的能力。", "推理题：同义替换", "把资金能力误换成降低成本、减少政府干预或免除部长责任。", "C 的 contribute to funding new developments 对应 significant impact on the ability to fund new developments。", "抽象名词题把 ability、impact 等表达还原为具体的资金结果。"),
      "2014-english2-text4-q40": analysis("The programme of grants ... set to expire in 2015, is unlikely to be extended beyond then ... [we are] unlikely to ever return to the era of large-scale public grants.", "Large public grants are unlikely to continue after 2015.", "这项拨款计划在 2015 年到期后不太可能延续，大规模公共补助时代也很难回归。", "推理题：否定与时间", "把短期欢迎措施或预算保留误读成继续大规模拨款。", "D 对应停止对住房领域的慷慨资助。", "时间推理题要同时抓 expire、unlikely、beyond then 等多个否定延续信号。"),
    },
    vocabulary: vocabulary([
      ["infrastructure", "n.", "Infrastructure usually refers to roads, railways, broadband and energy.", "基础设施", "住房补贴", "公共政策", "经济增长"],
      ["contribute to", "phr. v.", "Infrastructure contributes to the economy.", "有助于；促进", "取代；淘汰", "限制；阻碍", "评估；衡量"],
      ["seldom", "adv.", "Housing is seldom mentioned.", "很少；不常", "经常；总是", "特别；尤其", "逐渐；慢慢"],
      ["shoulder the blame", "phr.", "The housing sector must shoulder the blame.", "承担责任；受责备", "得到支持；受表扬", "转移问题；逃避", "扩大规模；增加"],
      ["communicate", "v.", "Housing has not been good at communicating its real value.", "传达；沟通", "计算；衡量", "限制；禁止", "融资；投资"],
      ["inevitable", "adj.", "It is inevitable that attention is focused elsewhere.", "不可避免的", "完全意外的", "公平合理的", "短暂可变的"],
      ["politically charged", "adj. phr.", "The issue has always been politically charged.", "政治敏感的；带政治色彩的", "经济可行的", "技术复杂的", "公众支持的"],
      ["affordable", "adj.", "The affordable housing situation is desperate.", "可负担的", "豪华昂贵的", "临时租住的", "政府拥有的"],
      ["desperate", "adj.", "The affordable housing situation is desperate.", "极其严重的；令人绝望的", "稳定乐观的", "暂时改善的", "受到关注的"],
      ["rectify", "v.", "The government can help rectify this.", "纠正；改正", "延续；保留", "比较；评估", "限制；阻止"],
      ["prejudice", "n.", "The government needs to put historical prejudices to one side.", "偏见；成见", "证据；事实", "政策；法规", "机会；优势"],
      ["indication", "n.", "There are indications that the government is preparing to act.", "迹象；表明", "限制；规定", "结果；结论", "责任；义务"],
      ["flexibility", "n.", "More flexibility may be introduced to the borrowing cap.", "灵活性；弹性", "限制性；约束", "稳定性；确定性", "能力；资格"],
      ["cap", "n.", "There is a cap on the amount local authorities can borrow.", "上限；限额", "增长；增加", "债务；贷款", "收入；税收"],
      ["authority", "n.", "Local authorities can borrow against housing debt.", "地方政府；主管机构", "住房供应者", "私人企业", "金融机构"],
      ["lift", "v.", "Extra homes could be built if the cap were lifted.", "解除；取消", "增加；提高", "保护；维持", "评估；审查"],
      ["rental", "adj.", "Ministers should create greater certainty in the rental environment.", "租赁的", "购买的", "公共的", "私人的"],
      ["provider", "n.", "Registered providers need to fund new developments.", "供应者；提供机构", "政府部长", "住房购买者", "政策制定者"],
      ["expire", "v.", "The programme of grants is set to expire in 2015.", "到期；失效", "延长；续期", "增加；扩大", "宣布；公布"],
      ["grant", "n.", "Large-scale public grants are unlikely to return.", "拨款；补助金", "债务；贷款", "税收；费用", "职位；资格"],
    ]),
  },
};
