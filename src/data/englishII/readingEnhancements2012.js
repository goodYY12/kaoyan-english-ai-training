...
export const readingEnhancements2012 = {
  ...
  "2012-english2-text4": {
    articleStructure: "P1 预言高失业时代将塑造一代人；P2 列举失业者所见的有限积极变化；P3-P4 转折，强调衰退总体会损害社会包容与权利；P5-P6 比较不同群体受创程度；P7-P8 以谨慎结论收束社会影响。",
    structureMap: [
      { paragraph: "P1", role: "引入", summary: "高失业并未结束，将长期重塑青年和社会。" },
      { paragraph: "P2", role: "有限正面影响", summary: "失业者试图从痛苦中找到节制消费等积极面。" },
      { paragraph: "P3-P4", role: "核心论证", summary: "转折后指出积极面微弱，长期停滞常带来排外、冲突和权利倒退。" },
      { paragraph: "P5-P8", role: "分层影响与结论", summary: "精英毕业生恢复较快，普通人被落下；社会影响确定但具体形态仍需观察。" },
    ],
    questions: {
      "2012-english2-text4-q36": analysis("No one tries harder than the jobless to find silver linings in this national economic disaster.", "the jobless try to find silver linings", "没有人比失业者更努力在这场全国性经济灾难中寻找一线希望。", "词义题：隐喻", "把 silver linings 按字面理解为补贴、利润或失业原因。", "D 用 look on the bright side 准确改写“在坏事中找积极面”。", "隐喻题优先看后文具体例子：less materialistic、financially prudent 都是积极面。"),
      "2012-english2-text4-q37": analysis("It has awoken us from our national fever dream of easy riches and bigger houses, and put a necessary end to an era of reckless personal spending.", "awoken us ... and put an end to reckless spending", "衰退使我们从轻易致富和大房子的迷梦中醒来，并结束了鲁莽的个人消费时代。", "细节题：同义替换", "只看失业痛苦而忽略作者本段列出的生活方式反思。", "D 对应人们重新考虑生活方式与消费观。", "抽象选项要找原文中的行为变化，如 spending、materialistic 等。"),
      "2012-english2-text4-q38": analysis("Lengthy periods of economic stagnation or decline have almost always left society more mean-spirited and less inclusive, and have usually stopped or reversed the advance of rights and freedoms.", "stagnation leaves society meaner, less inclusive and reverses rights", "长期经济停滞或衰退几乎总会使社会更刻薄、更不包容，并阻碍或逆转权利与自由的进步。", "细节题：负面评价", "把经济危机的短期消费节制当作 Friedman 的总体结论。", "B 概括衰退会激发更恶劣的人性和社会冲突。", "人物观点题从引号或归属句向后抓完整结论，不与作者前段的让步混淆。"),
      "2012-english2-text4-q39": analysis("Those with degrees from elite universities catch up fairly quickly ...; it is the masses beneath them that are left behind.", "elite graduates catch up; masses are left behind", "精英大学毕业生较快恢复原有机会，而其下的大多数人被落在后面。", "细节题：比较", "把 catch up 理解成赶上有经验员工，或把精英毕业生与普通人一样受损。", "D 概括精英毕业生比其他人恢复更快。", "比较结构中注意对照对象：elite graduates 与 masses beneath them。"),
      "2012-english2-text4-q40": analysis("We will have to wait and see exactly how these hard times will reshape our social fabric. But they certainly will reshape it, and all the more so the longer they extend.", "we must wait for exactly how; they certainly will reshape society", "我们还要等待观察艰难时期究竟如何重塑社会结构，但它们肯定会重塑社会，而且持续越久影响越大。", "态度题：确定性与保留", "只看到 wait and see 就选不确定，忽略 but 后 certainly 的确定判断。", "A 表示社会影响是确定的；不确定的是具体方式。", "态度题区分“是否发生”和“如何发生”，but 后的 certainly 往往是落点。"),
    },
    vocabulary: vocabulary([
      ["recession", "n.", "The great recession may be over, but this era of high joblessness is probably beginning.", "经济衰退", "经济复苏", "收入增长", "产业升级"],
      ["joblessness", "n.", "This era of high joblessness is probably beginning.", "失业状态", "就业机会", "工作效率", "职业培训"],
      ["reshape", "v.", "It is likely to reshape our politics, our culture, and the character of our society.", "重塑；改变结构", "维持；保存", "减少；压缩", "解释；说明"],
      ["silver lining", "n.", "The jobless try to find silver linings in this national economic disaster.", "困境中的一线希望", "政府补贴", "经济损失", "隐藏原因"],
      ["materialistic", "adj.", "They had become less materialistic and more financially prudent.", "物质至上的", "节俭谨慎的", "缺乏动力的", "乐观自信的"],
      ["prudent", "adj.", "They had become more financially prudent.", "谨慎的；审慎的", "冲动的；冒险的", "富裕的；奢侈的", "保守的；过时的"],
      ["reckless", "adj.", "It put an end to an era of reckless personal spending.", "鲁莽的；不计后果的", "有计划的；谨慎的", "必要的；合理的", "短期的；临时的"],
      ["stagnation", "n.", "Lengthy periods of economic stagnation or decline have left society less inclusive.", "停滞", "快速增长", "收入分配", "市场竞争"],
      ["mean-spirited", "adj.", "Economic decline has left society more mean-spirited and less inclusive.", "刻薄的；狭隘的", "慷慨的；包容的", "理性的；客观的", "谨慎的；节制的"],
      ["inclusive", "adj.", "Economic decline has left society less inclusive.", "包容的", "排他的", "高效的", "稳定的"],
      ["reverse", "v.", "Economic decline has stopped or reversed the advance of rights and freedoms.", "逆转；倒退", "促进；加速", "评估；衡量", "公开；传播"],
      ["sentiment", "n.", "Anti-immigrant sentiment typically increases.", "情绪；态度", "政策；法律", "收入；财富", "权利；自由"],
      ["inequality", "n.", "Income inequality usually falls during a recession.", "不平等", "收入增长", "社会流动", "经济周期"],
      ["reinforce", "v.", "Economic weakness may reinforce class divides.", "加强；加剧", "缩小；缓和", "解释；说明", "发现；揭示"],
      ["elite", "adj./n.", "Those with degrees from elite universities catch up fairly quickly.", "精英的；精英群体", "普通的；大众的", "落后的；边缘的", "私人的；封闭的"],
      ["dim", "v.", "Not all people graduating into a recession see their life chances dimmed.", "使暗淡；削弱", "使增加；改善", "使确定；固定", "使公开；展示"],
      ["resentment", "n.", "It is easy to see the resentment hidden within American society.", "怨恨；不满", "信任；支持", "乐观；希望", "贫困；失业"],
      ["discern", "v.", "It is difficult to discern precisely how lean times affect society's character.", "辨别；看清", "忽略；忘记", "预测；估计", "改善；修复"],
      ["lean", "adj.", "We must discern how these lean times are affecting society.", "困难的；萧条的", "繁荣的；富足的", "短暂的；偶然的", "平等的；包容的"],
      ["social fabric", "n.", "Hard times will reshape our social fabric.", "社会结构；社会关系网络", "社会福利制度", "公共建筑设施", "经济发展速度"],
    ]),
  },
};
