...
export const readingEnhancements2011 = {
  ...
  "2011-english2-text4": {
    ...
    vocabulary: vocabulary([
      ["European Union", "n.", "Will the European Union make it?", "欧盟", "欧洲委员会", "欧洲货币", "欧洲市场"],
      ["cheerleader", "n.", "Now even the project's greatest cheerleaders talk of a continent facing a Bermuda triangle of debt.", "热心支持者", "批评者", "政策制定者", "债务人"],
      ["debt", "n.", "Now even the project's greatest cheerleaders talk of a continent facing a Bermuda triangle of debt.", "债务", "信贷", "收入", "预算"],
      ["population decline", "n.", "Now even the project's greatest cheerleaders talk of a continent facing a Bermuda triangle of debt, population decline and lower growth.", "人口下降", "人口普查", "人口迁移", "人口增长"],
      ["acute", "adj.", "As well as those chronic problems, the EU faces an acute crisis in its economic core.", "严重而迫切的", "长期的", "轻微的", "隐蔽的"],
      ["converge", "v.", "Markets have lost faith that the euro zone's economies, weaker or stronger, will one day converge.", "趋同；汇合", "分化；分离", "崩溃；瓦解", "膨胀；扩大"],
      ["discipline", "n.", "Markets have lost faith that the euro zone's economies will one day converge thanks to the discipline of sharing a single currency.", "约束；纪律", "奖励；补贴", "偏见；歧视", "谈判；协商"],
      ["devaluation", "n.", "Sharing a single currency denies uncompetitive members the quick fix of devaluation.", "货币贬值", "货币升值", "财政转移", "利率上调"],
      ["disintegration", "n.", "The debate about how to save Europe's single currency from disintegration is stuck.", "瓦解；解体", "整合；统一", "复苏；增长", "扩张；外延"],
      ["harmonization", "n.", "France and Germany agree on the need for greater harmonization within the euro zone.", "协调；一致化", "隔离；分割", "竞争；对抗", "冻结；暂停"],
      ["stricter", "adj.", "Germany thinks the euro must be saved by stricter rules on borrowing, spending and competitiveness.", "更严格的", "更宽松的", "更灵活的", "更短期的"],
      ["borrowing", "n.", "Germany thinks the euro must be saved by stricter rules on borrowing, spending and competitiveness.", "借贷", "储蓄", "投资", "征税"],
      ["competitiveness", "n.", "Germany thinks the euro must be saved by stricter rules on borrowing, spending and competitiveness.", "竞争力", "生产率", "购买力", "流动性"],
      ["sanction", "n.", "The rules would be backed by quasi-automatic sanctions for governments that do not obey.", "制裁；处罚", "许可；批准", "援助；救济", "妥协；让步"],
      ["redistribution", "n.", "That means a system of redistribution from richer to poorer members.", "再分配", "私有化", "本地化", "数字化"],
      ["Eurobond", "n.", "Governments could borrow more cheaply through common Eurobonds or complete fiscal transfers.", "欧洲共同债券", "银行存款", "公司股票", "贸易协定"],
      ["fiscal transfer", "n.", "Governments could borrow more cheaply through common Eurobonds or complete fiscal transfers.", "财政转移", "货币兑换", "资本外逃", "税收减免"],
      ["curb", "v.", "Members should agree to some fiscal and social harmonization: for example, curbing competition in corporate-tax rates.", "抑制；限制", "鼓励；促进", "衡量；评估", "替代；取代"],
      ["write off", "phr. v.", "It is too soon to write off the EU.", "断定失败；不再看好", "正式成立", "全面改革", "公开支持"],
      ["trading bloc", "n.", "It remains the world's largest trading bloc.", "贸易集团", "金融中心", "军事联盟", "政府部门"],
    ]),
  },
};
